          ...
          <>
            ...
            <div className="flex justify-between px-5 bg-orange-600/90 text-white py-1 text-sm">
              <div className="w-full px-4 md:px-4 lg:px-8 py-2 flex justify-end md:justify-between md:items-center">
                {/* Desktop Tagline */}
                <h1 className="font-bold md:flex hidden gap-1">
                  BharaPins :
                  <span className="font-normal">
                    {" "}
                    India Best Local Search Engine
                  </span>
                </h1>
                ...
                <Sheet>
                  ...
                  <SheetContent
                    side="right"
                    className="bg-gradient-to-b from-white to-orange-50 border-l border-orange-200"
                  >
                    <div className="flex flex-col h-full">
                        ...
                        {!shouldHideNav && (
                          <>
                            <Link
                              href="/login"
                              target="_self"
                              className="flex items-center gap-2 text-orange-700 hover:text-orange-500 transition px-2 py-2 hover:bg-orange-100 rounded-md"
                            >
                      ...
                      <div className="mt-auto mb-6">
                        <div className="bg-orange-100 rounded-lg p-4 text-sm text-orange-800">
                          ...
                          <Link
                            href="/contact"
                            className="mt-3 inline-block font-medium text-orange-600/90 hover:text-orange-500"
                          >
                            Contact Support →
                          </Link>
                        </div>
